...
**读者端**：图书浏览、图书详情、我的借阅、我的收藏、个人资料、修改密码

- 个人资料页：点击右上角头像进入；包含基本信息（用户名、姓名只读，手机号、邮箱可编辑保存，手机号 11 位、邮箱含 @ 校验）+ 修改密码区域 + 退出登录按钮
- 修改密码：验证原密码、设置新密码、确认新密码
...
- 修改密码必须验证原密码，原密码错误不可修改
- 新密码长度 6-20 位，两次输入必须一致
- 密码使用哈希加密存储，不存明文
